...
export function SocialLoginButton({ provider, isLoading = false, onLogin }: SocialLoginButtonProps) {
  ...
  const getProviderColor = () => {
    switch (provider.type) {
      ...
      case 'microsoft':
        return 'border-blue-300 hover:border-blue-400 text-blue-700';
      case 'github':
        return 'border-gray-800 hover:border-gray-900 text-gray-800';
      case 'linkedin':
        return 'border-blue-600 hover:border-blue-700 text-blue-600';
      default:
        return 'border-gray-300 hover:border-gray-400 text-gray-700';
    }
  };
  ...
  return (
    <Button
      variant="outline"
      className={`w-full justify-start ${getProviderColor()}`}
      onClick={handleClick}
