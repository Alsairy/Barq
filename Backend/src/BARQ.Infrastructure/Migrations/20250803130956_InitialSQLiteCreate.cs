        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSystemPermission = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedById = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedById = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndpointUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ApiKey = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    Settings = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    CostPerToken = table.Column<decimal>(type: "TEXT", nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    Priority = table.Column<int>(type: "INTEGER", nullable: false),
                    SupportedTaskTypes = table.Column<string>(type: "TEXT", nullable: true),
                    QualityScore = table.Column<int>(type: "INTEGER", nullable: true),
                    AverageResponseTimeMs = table.Column<long>(type: "INTEGER", nullable: true),
                    AverageResponseTime = table.Column<long>(type: "INTEGER", nullable: true),
                    ...
                    SuccessRate = table.Column<decimal>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseDn = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    BindDn = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    BindPassword = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    UserSearchFilter = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    GroupSearchFilter = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    UserDnPattern = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    ...
                    GroupMembershipAttribute = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    IsEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsRequired = table.Column<bool>(type: "INTEGER", nullable: false),
                    AutoProvisionUsers = table.Column<bool>(type: "INTEGER", nullable: false),
                    DefaultRole = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    GroupRoleMappings = table.Column<string>(type: "TEXT", nullable: true),
                    ConnectionTimeout = table.Column<int>(type: "INTEGER", nullable: false),
                    SearchTimeout = table.Column<int>(type: "INTEGER", nullable: false),
                    LastSuccessfulAuth = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LastValidation = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsValid = table.Column<bool>(type: "INTEGER", nullable: false),
                    ValidationError = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    LastSynchronization = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedById = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedById = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SsoUrl = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    LogoutUrl = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    ...
                    Authority = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    CallbackUrl = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalAuthId = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ...
                    MfaSecretKey = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    MfaEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    MfaEnabledAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    MfaRecoveryToken = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    MfaRecoveryTokenExpiry = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedById = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedById = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkflowDefinition = table.Column<string>(type: "TEXT", nullable: false),
                    ApprovalSteps = table.Column<string>(type: "TEXT", nullable: false),
                    SLAConfiguration = table.Column<string>(type: "TEXT", nullable: true),
                    SlaHours = table.Column<int>(type: "INTEGER", nullable: true),
                    EscalationRules = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IPAddress = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ...
                    ComplianceFramework = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    ComplianceEventType = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    DataClassification = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    LegalBasis = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    RetentionPeriod = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    RetentionExpiryDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsPersonalData = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsSensitiveData = table.Column<bool>(type: "INTEGER", nullable: false),
                    ConsentId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ProcessingPurpose = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    DataSubjectId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ComplianceStatus = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    RegulatoryRequirement = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    RequiresNotification = table.Column<bool>(type: "INTEGER", nullable: false),
                    NotificationDeadline = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DigitalSignature = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    IntegrityHash = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    IsTamperProof = table.Column<bool>(type: "INTEGER", nullable: false),
                    ArchiveLocation = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectKey = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    ...
                    RepositoryBranch = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    LogoUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    Settings = table.Column<string>(type: "TEXT", nullable: true),
                    AIConfiguration = table.Column<string>(type: "TEXT", nullable: true),
                    DesignSystemUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ProjectOwnerId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RetryConfiguration = table.Column<string>(type: "TEXT", nullable: true),
                    ErrorHandling = table.Column<string>(type: "TEXT", nullable: true),
                    ExecutionConditions = table.Column<string>(type: "TEXT", nullable: true),
                    RequiresApproval = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    AllowParallelExecution = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    AllocationPercentage = table.Column<decimal>(type: "TEXT", nullable: true),
                    ProjectId = table.Column<Guid>(type: "TEXT", nullable: false),
                    UserId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Budget = table.Column<decimal>(type: "TEXT", nullable: true),
                    AICost = table.Column<decimal>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    AsAUser = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    IWant = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    SoThat = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    ...
                    AIGenerationMetadata = table.Column<string>(type: "TEXT", nullable: true),
                    ProjectId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkflowData = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    SprintId = table.Column<Guid>(type: "TEXT", nullable: true),
                    UserStoryId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ...
                    SprintId1 = table.Column<Guid>(type: "TEXT", nullable: true),
                    UserStoryId1 = table.Column<Guid>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedById = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedById = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AIRequests_Users_AssignedToId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AIRequests_WorkflowInstances_WorkflowInstanceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AIProviderConfigurationId = table.Column<Guid>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedById = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedById = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Name = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Scope = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "workflow"),
                    ...
                    AccessPermissions = table.Column<string>(type: "TEXT", nullable: true),
                    ValidationRules = table.Column<string>(type: "TEXT", nullable: true),
                    TransformationRules = table.Column<string>(type: "TEXT", nullable: true),
                    ExpiresAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    WorkflowInstanceId = table.Column<Guid>(type: "TEXT", nullable: true),
                    WorkflowStepId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ParentContextId = table.Column<Guid>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedById = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedById = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExecutedById = table.Column<Guid>(type: "TEXT", nullable: true),
                    AssignedToId = table.Column<Guid>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedById = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order = table.Column<int>(type: "INTEGER", nullable: false),
                    DueDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DelegatedToId = table.Column<Guid>(type: "TEXT", nullable: true),
                    DelegatedFromId = table.Column<Guid>(type: "TEXT", nullable: true),
                    DelegatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DelegationReason = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedById = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedById = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIRequestApprovals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AIRequestApprovals_AIRequests_AIRequestId",
                        column: x => x.AIRequestId,
                        principalTable: "AIRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AIRequestApprovals_Users_ApproverId",
                        column: x => x.ApproverId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AIRequestApprovals_Users_DelegatedFromId",
                        column: x => x.DelegatedFromId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AIRequestApprovals_Users_DelegatedToId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    AIRequestId = table.Column<Guid>(type: "TEXT", nullable: false),
                    AssessorId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Type = table.Column<int>(type: "INTEGER", nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    CompletedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    QualityCriteria = table.Column<string>(type: "TEXT", nullable: false),
                    AssessmentResults = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QualityAssessment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QualityAssessment_AIRequests_AIRequestId",
                        column: x => x.AIRequestId,
                        principalTable: "AIRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QualityAssessment_Users_AssessorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AIProvider = table.Column<int>(type: "INTEGER", nullable: true),
                    AIModel = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    TokensUsed = table.Column<int>(type: "INTEGER", nullable: true),
                    CostPerToken = table.Column<decimal>(type: "TEXT", nullable: true),
                    ProcessingTimeMs = table.Column<long>(type: "INTEGER", nullable: true),
                    ...
                    AllocationPercentage = table.Column<decimal>(type: "TEXT", nullable: true),
                    ExternalInvoiceId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ...
                    BillingRate = table.Column<decimal>(type: "TEXT", nullable: true),
                    BillableAmount = table.Column<decimal>(type: "TEXT", nullable: true),
                    Tags = table.Column<string>(type: "TEXT", nullable: true),
                    Metadata = table.Column<string>(type: "TEXT", nullable: true),
                    ProjectId = table.Column<Guid>(type: "TEXT", nullable: true),
                    SprintId = table.Column<Guid>(type: "TEXT", nullable: true),
                    UserStoryId = table.Column<Guid>(type: "TEXT", nullable: true),
                    AITaskId = table.Column<Guid>(type: "TEXT", nullable: true),
                    AIProviderConfigurationId = table.Column<Guid>(type: "TEXT", nullable: true),
                    UserId = table.Column<Guid>(type: "TEXT", nullable: true),
                    Team = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    Department = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ITSMSystem = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ...
                    AssignmentGroup = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ...
                    SLADueDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ResolutionNotes = table.Column<string>(type: "TEXT", nullable: true),
                    ClosureCode = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    QualityAssessmentId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QualityMetric", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QualityMetric_QualityAssessment_QualityAssessmentId",
                        column: x => x.QualityAssessmentId,
                        principalTable: "QualityAssessment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalUserName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    IsPublic = table.Column<bool>(type: "INTEGER", nullable: false),
                    ITSMTicketId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedById = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedById = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIRequestApprovals_AIRequestId",
                table: "AIRequestApprovals",
                column: "AIRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_AIRequestApprovals_ApproverId",
                table: "AIRequestApprovals",
                column: "ApproverId");

            migrationBuilder.CreateIndex(
                name: "IX_AIRequestApprovals_DelegatedFromId",
                table: "AIRequestApprovals",
                column: "DelegatedFromId");

            migrationBuilder.CreateIndex(
                name: "IX_AIRequestApprovals_DelegatedToId",
                table: "AIRequestApprovals",
                column: "DelegatedToId");

            migrationBuilder.CreateIndex(
                name: "IX_AIRequests_AssignedToId",
                table: "AIRequests",
                column: "AssignedToId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIRequests_WorkflowInstanceId",
                table: "AIRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QualityAssessment_AIRequestId",
                table: "QualityAssessment",
                column: "AIRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_QualityAssessment_AssessorId",
                table: "QualityAssessment",
                column: "AssessorId");

            migrationBuilder.CreateIndex(
                name: "IX_QualityMetric_QualityAssessmentId",
                table: "QualityMetric",
                column: "QualityAssessmentId");
